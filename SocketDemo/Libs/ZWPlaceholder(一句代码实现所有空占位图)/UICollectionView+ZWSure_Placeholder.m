//
//  UICollectionView+ZWSure_Placeholder.m
//  EasyIM
//
...
@implementation UICollectionView (ZWSure_Placeholder)
+ (void)load {
...
- (void)makeDefaultPlaceholderView {
    ...
    ZWSurePlaceholderView *placeholderView = [[ZWSurePlaceholderView alloc]initWithFrame:self.bounds];
